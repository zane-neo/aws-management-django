...
def replace_with_a_new_file():
    with open('/Users/zaniu/Documents/code/shells/opensearch.yml', 'r') as file:
        ...
        with open('/Users/zaniu/Documents/code/shells/opensearch.yml.temp', 'a') as temp:
            for line in file:
...
def replace_inplace():
    ...
    with open('/Users/zaniu/Documents/code/shells/opensearch.yml', 'w') as temp:
       temp.write(content)
